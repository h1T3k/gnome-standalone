...
<span style="color: red">## STANDALONE
</span>
...
<span style="color: orange">## Setting up BTRFS filesystems.
</span>
...
<span style="color: yellow">## Reconfigure lightdm to allow booting into read-only snapshots
</span>
...
<span style="color: green">## Mount your root partition
</span>
	sudo mount /dev/mapper/nvme0n1p4_crypt /mnt



<span style="color: blue">## Create read-only snapshots for XFCE
</span>
...
<span style="color: indigo">## Move directories to the snapshots
</span>
...
<span style="color: violet">## Enabling cryptomount in GRUB2 + REMOVABLE MODE, KEYSLOT SETUP & AUTO-UNLOCK
</span>
...
<span style="color: red">## Avoiding the Extra Password Prompt
</span>
...
<span style="color: orange">## Finishing up BTRFS
</span>
...
<span style="color: yellow">## We're in....
</span>
